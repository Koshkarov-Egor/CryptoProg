...
int main(int argc, char* argv[])
{
    ...
    if(ende == "en") {
        ...
        ofstream userPass("/home/egor22ptv2/Lab4/cipher/userPass"); //Запись
        StringSource(pass, true, new FileSink(userPass));
        ofstream userKey("/home/egor22ptv2/Lab4/cipher/fileKey");
        ArraySource(key, sizeof(key), true, new FileSink(userKey));
        ofstream userIV("/home/egor22ptv2/Lab4/cipher/fileIV");
        ...
        string passNow;
        cin >> passNow;
        FileSource("/home/egor22ptv2/Lab4/cipher/userPass",
        ...
        FileSource("/home/egor22ptv2/Lab4/cipher/fileKey",
                   true, new ArraySink(key, sizeof(key)));

        byte IV[AES::BLOCKSIZE]; //Чтение IV
        FileSource("/home/egor22ptv2/Lab4/cipher/Initial/fileIV",
